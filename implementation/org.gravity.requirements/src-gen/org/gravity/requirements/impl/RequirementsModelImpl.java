 ...
 * </p>
 * <ul>
 *   <li>{@link org.gravity.requirements.impl.RequirementsModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.gravity.requirements.impl.RequirementsModelImpl#getUsecases <em>Usecases</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementsModelImpl extends MinimalEObjectImpl.Container implements RequirementsModel {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENTS_MODEL__NAME, oldName,
					name));
	}
	...
	public EList<UseCase> getUsecases() {
		if (usecases == null) {
			usecases = new EObjectContainmentWithInverseEList<UseCase>(UseCase.class, this,
					RequirementsPackage.REQUIREMENTS_MODEL__USECASES, RequirementsPackage.USE_CASE__MODEL);
		}
		return usecases;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RequirementsPackage.REQUIREMENTS_MODEL__USECASES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RequirementsPackage.REQUIREMENTS_MODEL__NAME:
			return getName();
		case RequirementsPackage.REQUIREMENTS_MODEL__USECASES:
			return getUsecases();
		}
