...
public class GraphConfigurationPackageImpl extends EPackageImpl implements GraphConfigurationPackage
{
   ...
   */
  @Override
  public EAttribute getAttributeWeight_Owner()
  {
    return (EAttribute)attributeWeightEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EReference)attributeWeightEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(attributeWeightEClass, ATTRIBUTE_WEIGHT__OWNER);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getAttributeWeight_Owner(), this.getOwner(), "owner", null, 0, 1, AttributeWeight.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEEnumLiteral(ownerEEnum, Owner.TARGET);
    addEEnumLiteral(ownerEEnum, Owner.ASSOCIATION);
