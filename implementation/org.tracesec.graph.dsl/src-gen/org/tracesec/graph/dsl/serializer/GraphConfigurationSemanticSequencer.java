...
public class GraphConfigurationSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_AttributeWeight(ISerializationContext context, AttributeWeight semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GraphConfigurationPackage.Literals.ATTRIBUTE_WEIGHT__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GraphConfigurationPackage.Literals.ATTRIBUTE_WEIGHT__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAttributeWeightAccess().getValueEAttributeIDTerminalRuleCall_0_1(), semanticObject.eGet(GraphConfigurationPackage.Literals.ATTRIBUTE_WEIGHT__VALUE, false));
		feeder.finish();
	}
