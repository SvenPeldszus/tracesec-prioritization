...
public class GraphConfigurationGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class AttributeWeightElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Assignment cOwnerAssignment_0_0 = (Assignment)cGroup_0.eContents().get(0);
		private final RuleCall cOwnerOwnerEnumRuleCall_0_0_0 = (RuleCall)cOwnerAssignment_0_0.eContents().get(0);
		private final Keyword cFullStopKeyword_0_1 = (Keyword)cGroup_0.eContents().get(1);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final CrossReference cValueEAttributeCrossReference_1_0 = (CrossReference)cValueAssignment_1.eContents().get(0);
		private final RuleCall cValueEAttributeIDTerminalRuleCall_1_0_1 = (RuleCall)cValueEAttributeCrossReference_1_0.eContents().get(1);
		
		//AttributeWeight: (owner=Owner ".")? value=[ecore::EAttribute];
		@Override public ParserRule getRule() { return rule; }
		
		//(owner=Owner ".")? value=[ecore::EAttribute]
		public Group getGroup() { return cGroup; }
		...
		//owner=Owner
		public Assignment getOwnerAssignment_0_0() { return cOwnerAssignment_0_0; }
		
		//Owner
		public RuleCall getOwnerOwnerEnumRuleCall_0_0_0() { return cOwnerOwnerEnumRuleCall_0_0_0; }
		...
		//[ecore::EAttribute]
		public CrossReference getValueEAttributeCrossReference_1_0() { return cValueEAttributeCrossReference_1_0; }
		
		//ID
		public RuleCall getValueEAttributeIDTerminalRuleCall_1_0_1() { return cValueEAttributeIDTerminalRuleCall_1_0_1; }
	}
	
	public class OwnerElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.tracesec.graph.dsl.GraphConfiguration.Owner");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final Keyword cTARGETTrgKeyword_0_0 = (Keyword)cTARGETEnumLiteralDeclaration_0.eContents().get(0);
		...
		//"trg"
		public Keyword getTARGETTrgKeyword_0_0() { return cTARGETTrgKeyword_0_0; }
	...
	private final OwnerElements eOwner;
