...
public class RequirementsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case RequirementsPackage.REQUIREMENTS_SET: {
			RequirementsSet requirementsSet = (RequirementsSet) theEObject;
			T result = caseRequirementsSet(requirementsSet);
			if (result == null)
				result = caseAbstractRequirement(requirementsSet);
			if (result == null)
		...
		case RequirementsPackage.REQUIREMENT: {
			...
			if (result == null)
				result = caseAbstractRequirement(requirement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RequirementsPackage.REQUIREMENT_RELATION: {
	 ...
	 * @generated
	 */
	public T caseRequirementsSet(RequirementsSet object) {
		return null;
	}
