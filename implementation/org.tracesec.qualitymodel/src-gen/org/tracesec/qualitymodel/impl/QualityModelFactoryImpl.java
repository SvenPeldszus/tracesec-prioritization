...
public class QualityModelFactoryImpl extends EFactoryImpl implements QualityModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case QualityModelPackage.QUALITY_MODEL: return createQualityModel();
			case QualityModelPackage.QUALITY: return createQuality();
			case QualityModelPackage.ASPECT: return createAspect();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case QualityModelPackage.PRIORITY:
